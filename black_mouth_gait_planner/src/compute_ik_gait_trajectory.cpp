...
int computeGaitTrajectory(
    rclcpp::Client<black_mouth_gait_planner::srv::ComputeGaitTrajectory>::SharedPtr  client_gait, rclcpp::Node::SharedPtr node)
    {
        auto request_gait = std::make_shared<black_mouth_gait_planner::srv::ComputeGaitTrajectory::Request>();
            ...
            rclcpp::FutureReturnCode::SUCCESS)
        {
            ...
            rclcpp::Publisher<black_mouth_kinematics::msg::BodyLegIKTrajectory>::SharedPtr publisher_ik =   node->create_publisher<black_mouth_kinematics::msg::BodyLegIKTrajectory>("cmd_ik", 10);
            ...
            for (int i = 0; i < request_gait->resolution; i++) {
                ...
                msg.body_leg_ik_trajectory[i].leg_points.reference_link = black_mouth_kinematics::msg::AllLegPoints::FOOT_LINK_AS_REFERENCE;
...
int main(int argc, char **argv) {
    ...
    rclcpp::Client<black_mouth_gait_planner::srv::ComputeGaitTrajectory>::SharedPtr client_gait =
        node->create_client<black_mouth_gait_planner::srv::ComputeGaitTrajectory>("compute_gait_trajectory");

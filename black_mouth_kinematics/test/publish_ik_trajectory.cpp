...
int main(int argc, char **argv)
{
  ...
  msg.body_leg_ik_trajectory[8].leg_points.reference_link = black_mouth_kinematics::msg::AllLegPoints::FOOT_LINK_AS_REFERENCE;
  ...
  msg.body_leg_ik_trajectory[9].leg_points.reference_link = black_mouth_kinematics::msg::AllLegPoints::FOOT_LINK_AS_REFERENCE;

...
#include "caramel_control/BodyControl.hpp"
...
BodyControl::BodyControl() : Node("body_control")
{
  ...
  _body_control_publisher = this->create_publisher<caramel_control::msg::BodyControl>("body_control", 10);
...
{
  auto ik_msg = caramel_kinematics::msg::BodyLegIKTrajectory();

...
#include "caramel_kinematics/InverseKinematics.hpp"
...
InverseKinematics::InverseKinematics() : Node("inverse_kinematics_node")
{
  ...
  _cmd_subscriber = this->create_subscription<caramel_kinematics::msg::BodyLegIKTrajectory>("cmd_ik", 10, 
...
void InverseKinematics::defaultPoseCallback(const std_msgs::msg::Empty::SharedPtr msg)
{
  ...
  this->_cmd_ik_msg.body_leg_ik_trajectory.at(0).leg_points.reference_link  = caramel_kinematics::msg::AllLegPoints::FOOT_LINK_AS_REFERENCE;

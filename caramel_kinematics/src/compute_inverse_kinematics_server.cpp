...
caramel_kinematics::msg::LegJoints getLegIK(const geometry_msgs::msg::Point point, bool left=false)
{
  ...
  caramel_kinematics::msg::LegJoints leg_joints;
...
void computeInvKinematics(const std::shared_ptr<caramel_kinematics::srv::InvKinematics::Request> request,
                                std::shared_ptr<caramel_kinematics::srv::InvKinematics::Response> responde)
{
  ...
  if (request->body_leg_ik.leg_points.reference_link == caramel_kinematics::msg::AllLegPoints::FOOT_LINK_AS_REFERENCE)
  {
  ...
  else if (request->body_leg_ik.leg_points.reference_link == caramel_kinematics::msg::AllLegPoints::HIP_LINK_AS_REFERENCE)
  {
...
int main(int argc, char **argv)
{
  ...
  rclcpp::Service<caramel_kinematics::srv::InvKinematics>::SharedPtr service = 
    node->create_service<caramel_kinematics::srv::InvKinematics>("compute_inverse_kinematics", &computeInvKinematics);

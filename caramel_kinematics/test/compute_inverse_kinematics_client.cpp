...
#include "caramel_kinematics/msg/body_leg_ik.hpp"
...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<caramel_kinematics::srv::InvKinematics>::SharedPtr client =
    node->create_client<caramel_kinematics::srv::InvKinematics>("compute_inverse_kinematics");

  auto request = std::make_shared<caramel_kinematics::srv::InvKinematics::Request>();
  ...
  // request->body_leg_ik.leg_points.reference_link = caramel_kinematics::msg::AllLegPoints::BASE_LINK_AS_REFERENCE;
  ...
  request->body_leg_ik.leg_points.reference_link = caramel_kinematics::msg::AllLegPoints::FOOT_LINK_AS_REFERENCE;
  ...
  // request->body_leg_ik.leg_points.reference_link = caramel_kinematics::msg::AllLegPoints::HIP_LINK_AS_REFERENCE;
  // request->body_leg_ik.leg_points.front_right_leg.x = 0.0;
  ...
  {
    caramel_kinematics::msg::LegJoints front_right = result.get()->leg_joints.front_right_leg;
    caramel_kinematics::msg::LegJoints front_left  = result.get()->leg_joints.front_left_leg;
    caramel_kinematics::msg::LegJoints back_left   = result.get()->leg_joints.back_left_leg;
    caramel_kinematics::msg::LegJoints back_right  = result.get()->leg_joints.back_right_leg;

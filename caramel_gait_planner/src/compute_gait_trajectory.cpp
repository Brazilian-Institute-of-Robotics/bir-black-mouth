...
void computeGaitTrajectory(
    const std::shared_ptr<
        caramel_gait_planner::srv::ComputeGaitTrajectory::Request>
        request,
    std::shared_ptr<
        caramel_gait_planner::srv::ComputeGaitTrajectory::Response>
        response) {
...
int main(int argc, char **argv) {
    ...
    rclcpp::Service<caramel_gait_planner::srv::ComputeGaitTrajectory>::
        SharedPtr service = node->create_service<
            caramel_gait_planner::srv::ComputeGaitTrajectory>(
